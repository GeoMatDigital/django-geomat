# -*- coding: utf-8 -*-
"""
Django settings for GU Geomat project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (geomat/config/settings/common.py - 3 = geomat/)
...
ADMINS = (
    ("""Michael Gecht""", 'mgecht@stud.uni-frankfurt.de'),
)
